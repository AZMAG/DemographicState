        ...
        function() {
            var demographicConfig = new function() {
                ...
                self.selectedACSBlockGroups = [
                    ...
                    { field: "MINORITY_POP", title: "Minority Population", width: "80px", format: "{0:n0}" },
                    { field: "MEDIAN_AGE", title: "Median Age", width: "55px", format: "{0:n2}" },
                    { field: "WHITE_NON_HISPANIC", title: "White Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "BLACK_NON_HISPANIC", title: "Black Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "NATIVE_NON_HISPANIC", title: "Native Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "ASIAN_NON_HISPANIC", title: "Asian Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "PACIFIC_NON_HISPANIC", title: "Pacific Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "TWO_OR_MORE_NON_HISPANIC", title: "Two or More Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "OTHER_NON_HISPANIC", title: "Other Non-Hispanic", width: "95px", format: "{0:n0}" },
                    { field: "HISPANIC", title: "Hispanic", width: "60px", format: "{0:n0}" },
                    { field: "NON_HISPANIC", title: "Non Hispanic", width: "60px", format: "{0:n0}" },
                    ...
                    { field: "LINGISO_HH", title: "Linguistically Isolated Households", width: "150px", format: "{0:n0}" },
                    ...
                    { field: "VACANCY_RATE_OF_SEASONAL", title: "Seasonal Vacancy Rate", width: "150px", format: "{0:n0}" },
                    { field: "VACANCY_RATE_OF_NON_SEASONAL", title: "Non-Seasonal Vacancy Rate", width: "150px", format: "{0:n0}" },
                    ...
                    { field: "TOT_WORKERS_16PLUS", title: "Total Workers 16 Plus", width: "150px", format: "{0:n0}" },
                    { field: "CIVILIAN_EMPLOYED_16_PLUS", title: "Civilian Employed Population 16 Plus", width: "150px", format: "{0:n0}" },
                    { field: "CIVILIAN_EMPLOYED_18_PLUS", title: "Civilian Employed Population 18 Plus", width: "150px", format: "{0:n0}" },
