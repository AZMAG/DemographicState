...
(function () {
    ...
    define([
        ...
        function (dc, da, lang, on, ds, Search, FeatureLayer, Locator, Extent, PictureMarkerSymbol, SimpleFillSymbol, view, mapModel, searchConfig, demographicVM) {
				...
				self.UpdateMap = function(e)
				 ...
				 if(e.result)
						...
						if (e.sourceIndex === 5) 
						{
							...
							var graphic = new esri.Graphic(e.result.feature.geometry, symbol);
