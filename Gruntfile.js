...
module.exports = function (grunt) {
    ...
    var includedModules = ["mag/app"];
    var excludedModules = ["dojo/domReady", "dojo/parser", "dojo/topic"];
    var paths = {
        mag: "",
        dojo: "empty:",
    ...
    grunt.registerTask("GetClassBreaks", function () {
        require("./src/app/vendor/js/generateClassBreaks.js")(
            grunt,
            this.async,
            {
                inputLocation: "./src/app/js/config/cbrConfig.json",
                geoStatsPath:
                    "Z:\\Viewers\\Demographics\\src\\app\\vendor\\js\\geoStats.min.js",
                mainUrl:
