...
define([
    ...
    let GenerateReportDataFromAttributes;
    tp.subscribe("panel-loaded", function (panel) {
        if (panel === "reports-view") {
            ...
            function resetReportForm() {
                ...
                let specificReportCbox = $("#specificReport").data(
                    "kendoComboBox"
                );
    ...
    GenerateReportDataFromAttributes = function (attr, fields) {
        console.log(attr);
        let valsDef = {};
        let vals = [];
        let duplicates = {};
        ...
        for (let i = 0; i < fields.length; i++) {
            ...
            valsDef[fld.fieldName] = {
                ...
                fieldValueFormatted: utilities
                    .numberWithCommas(Number(val).toFixed(1))
                    .replace(".0", ""),
    ...
    function OpenReportWindow(data, type) {
        ...
        let vals = GenerateReportDataFromAttributes(attr, fields);
        console.log(vals);
        if (features.length > 1) {
            let compareVals = GenerateReportDataFromAttributes(
                features[1].attributes,
                fields
            );
    ...
    function SetupTitle6Grid(attr) {
        ...
        let dataSrc = [
            ...
            },
            {
                ...
                PercentAffectedCaptured:
                    attr["AFFECTED_LIMITED_ENG_PROF"] /
                    attr["LIMITED_ENG_PROF"],
            },
        ];
    ...
    return GenerateReportDataFromAttributes;
});
