define([], function () {
    var config = {
        ...
        mainUrl:
            "https://geo.azmag.gov/arcgis/rest/services/maps/DemographicState2017/MapServer",
        printUrl:
            "https://geo.azmag.gov/arcgis/rest/services/gp/stateDemo/GPServer/Export%20Web%20Map",
        pdfService: {
            defaultUrl:
                "https://geo.azmag.gov/services/demographics2017/Reports.html?",
            compareUrl:
                "https://geo.azmag.gov/services/demographics2017/CompareReport.html?",
        },
        ...
        layers: [
            {
                ...
                title:
                    "American Community Survey by Block Group, 2013-2017 5 year estimates",
                type: "image",
                opacity: 0.8,
                visible: true,
                showReport: false,
            ...
            },
            {
                ...
                showTOC: true,
                definition:
                    "The streets layer adds a transportation layer from ESRI for reference.",
                url:
            ...
            },
            {
                ...
                showTOC: true,
                definition:
                    "Councils of governments (CoGs—also known as regional councils, regional commissions, regional planning commissions, and planning districts) are regional governing and/or coordinating bodies.",
                layerListOrder: 17,
            },
            {
                legend: true,
            ...
            },
            {
                ...
                showTOC: true,
                definition:
                    "The council of a metropolitan district that has been granted city status. The council of a non-metropolitan district that has been granted city status. Some of these councils are unitary authorities and some share functions with county councils. A parish council that has been granted city status.",
                layerListOrder: 6,
            },
            {
                legend: true,
                ...
                showTOC: true,
                definition:
                    "Legislative districts are areas from which members are elected to state or equivalent entity legislatures. State legislative districts embody the upper (senate—SLDU) and lower (house—SLDL) chambers of the state legislatures.",
                layerListOrder: 7,
            },
            {
                legend: true,
                ...
                showTOC: true,
                definition:
                    "A congressional district is a territorial subdivision for electing members to a legislative body. Generally, only voters (constituents) who reside within the district are permitted to vote in an election held there.  There are 435 congressional districts in the United States House of Representatives, with each one representing approximately 711,000 people.",
                layerListOrder: 8,
            },
            {
                legend: true,
                ...
                labelClass: {
                    labelExpressionInfo: {
                        expression:
                            "Replace($feature.NAME, 'Census Tract ', '')",
                    },
                    symbol: {
                        type: "text",
                        color: "black",
            ...
            },
            {
                ...
                showTOC: true,
                definition:
                    "A Elementary School District is a school distict that generally provides education to the lower grade/age levels - grades K-8.",
                layerListOrder: 11,
            },
            {
                legend: true,
                ...
                showTOC: true,
                definition:
                    "A Secondary School District is a school distict that generally provides education to the upper grade/age levels - grades 9-12.",
                layerListOrder: 12,
            },
            {
                legend: true,
            ...
            },
            {
                ...
                showTOC: true,
                definition:
                    "State is a combination or association of persons in the form of government and governed and united together into a politically organized people of a definite territory.",
                layerListOrder: 18,
            },
        ],
        ...
        sourceLabel:
            "Source: United States Census Bureau, American Community Survey 2013-2017 5yr Estimates",
